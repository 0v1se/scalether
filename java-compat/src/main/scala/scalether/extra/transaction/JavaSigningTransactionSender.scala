...
class JavaSigningTransactionSender(ethereum: JavaEthereum, nonceProvider: JavaNonceProvider, privateKey: BigInteger, gas: BigInteger, gasPrice: BigInteger)
  extends SigningTransactionSender[CompletableFuture](ethereum, nonceProvider, privateKey, gas, gasPrice) with JavaTransactionSender {
